...
#=====================DATA FRAME=========================================
        ...
        DataFrameLeft.place(x=-17,y=5,width=830,height=350)
        DataFrameRight=LabelFrame(DataFrame,bd=10,relief=RIDGE,padx=20,text="Product Information",
                                 fg='darkblue',font=("arial",12,"bold"))
        DataFrameRight.place(x=820,y=5,width=650,height=364)
#========================buttonsFrame=====================================
 ...
 #=======================Main Buttin=========================================
        ...
        btnAddData=Button(ButtonFrame,text="EXIT",command=self.gen_bill,font=("arial",13,"bold"),width=14,bg="darkgreen",fg="white")
...
#=============================Add product=========================================================
        lblcustno=Label(DataFrameLeft,font=("arial",12,"bold"),text="customer Id:",padx=2)
        ...
        txtcustnam=Entry(DataFrameLeft,textvariable=self.custnam,font=("arial",12,"bold"),width=25)
        ...
        txtAddress=Entry(DataFrameLeft,textvariable=self.add,font=("arial",12,"bold"),width=25)
        txtAddress.grid(row=3,column=1)
        lblphno=Label(DataFrameLeft,font=("arial",12,"bold"),text="Phone no.1",padx=2,pady=6)
        lblphno.grid(row=4,column=0,sticky=W)
        txtphno=Entry(DataFrameLeft,textvariable=self.pno,font=("arial",12,"bold"),width=25)
        txtphno.grid(row=4,column=1)
        lblphnnt=Label(DataFrameLeft,font=("arial",12,"bold"),text="Phone no.2",padx=2,pady=6)
        lblphnnt.grid(row=5,column=0,sticky=W)
        txtphnnt=Entry(DataFrameLeft,textvariable=self.pnt,font=("arial",12,"bold"),width=25)
        ...
        #===========================total=========================
        #lblTotal = Label(DataFrameLeft, font=("arial", 12, "bold"), text="Total:", pady=0, padx=0)
        #lblTotal.grid(row=6, column=3, sticky=W)
        #txttprice=Entry(DataFrameLeft,textvariable=self.tprice,font=("arial",12,"bold"),width=27)
        #txttprice.grid(row=6,column=4)
        #==========================actual price=============================
        ...
        txtprdname = Entry(DataFrameRight, textvariable=self.addprdnam_var, font=("arial", 12, "bold"), width=25)
        ...
        txtcat = Entry(DataFrameRight, textvariable=self.addcat_var, font=("arial", 12, "bold"), width=25)
        ...
        txtexpiredate = Entry(DataFrameRight, textvariable=self.expdat_var, font=("arial", 12, "bold"), width=25)
        ...
        txtdis = Entry(DataFrameRight, textvariable=self.disc_var, font=("arial", 12, "bold"), width=25)
        ...
        txtprice = Entry(DataFrameRight, textvariable=self.pric_var, font=("arial", 12, "bold"), width=25)#use as selling price
        txtprice.place(x=115, y=165)
    
       
        #============================search box sideframe=========================
        # Inside the __init__ method, after creating the side_frame

#===========================search box side frame=========================
       

        #===========================side frame ================================
        side_frame=Frame(DataFrameRight,bd=4,relief=RIDGE,bg="White")
        side_frame.place(x=0,y=200,width=580,height=120)
...
#=========================product Add Button ============================
        ...
        self.store_table.heading("pht",text="PHONE NO.2")
    ...
    def Add_data(self):
        if self.prdid.get()=="":
            ...
            try:
                    ...
                    my_cursor.execute("insert into order_detail(cust_id,cust_nam,address,phon_o,phon_t,prod_id,prod_nam,categ,expdat,tim,price,subtotal,tax,total) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                                                                                                                                                                                    self.custid.get(),
                                                                                                                                                                                    self.custnam.get(),
                                                                                                                                                                                    self.add.get(),
                                                                                                                                                                                    self.pno.get(),
                    ...
                    my_cursor.execute("insert into cust_data(custid,custnam,custadd,pno,pnt) values(%s,%s,%s,%s,%s)",(
                        self.custid.get(),
                                                                                                                                                                                    self.custnam.get(),
                                                                                                                                                                                    self.add.get(),
                                                                                                                                                                                    self.pno.get(),
    ...
    def Update(self):
         if self.custid.get()=="" or self.prdid.get()=="":
              messagebox.showerror("Error","All fild are Required")
               ...
               my_cursor.execute("UPDATE order_detail SET cust_nam=%s, address=%s, phon_o=%s, phon_t=%s, prod_id=%s, prod_nam=%s,categ=%s,expdat=%s,tim=%s,price=%s WHERE cust_id=%s", (
                                                                                                                                                                            self.custnam.get(),
                                                                                                                                                                            self.add.get(),
                                                                                                                                                                            self.pno.get(),
                                                                                                                                                                            self.pnt.get(),
         ...
         my_cursor.execute("UPDATE cust_data SET custnam=%s, custadd=%s, pno=%s, pnt=%s WHERE custid=%s", (
                                                                                                                                                                            self.custnam.get(),
                                                                                                                                                                            self.add.get(),
                                                                                                                                                                            self.pno.get(),
                                                                                                                                                                            self.pnt.get(),
